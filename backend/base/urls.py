...
urlpatterns = [
    ...
    path("get_user/<str:token>", views.get_user),
    path("new_user/<str:club_name>/<str:name>/<int:phno>", views.new_user),
    path("take_attendence/<str:club_name>/<str:lat>/<str:long>", views.take_attendence),
